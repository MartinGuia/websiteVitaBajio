...
function RenewedAllPosition() {
    const CatalogueRenewedAllPosition = [
        ...
        },
        {
          ...
          caract2:
            "- Buen desempeño en recorridos de corta y larga distancia.",
          caract3:
            "- Buen desempeño en cascos radiales como convencionales.",
          medida1: "235/75R17.5",
          medida2: "255/70R22.5",
          medida3: "225/70R19.5",
          ancho1: "3",
        ...
        },
        {
          ...
          caract2:
            "- Canales redondeados que facilitan la autolimpieza.",
          caract3:
            "- Alta resistencia a cortes y pinchazos.",
          caract4:
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-3">
      {CatalogueRenewedAllPosition.map((card) => (
        ...
        >
          ...
          <div className="mt-1">
            <img className="size-28" src={card.img1} alt="Llanta renovada toda posición" />
          </div>
          <div className="flex">
